...
DailyDatas = pd.read_csv(r'C:\Users\Coopsy\Desktop\afprepo\Projects\eghajlati_adatsor_1901-2020Budapest\napi_adatok\BP_d.txt', sep=';', skiprows=1, names=DailyDatas_columns)
print(DailyDatas)